                ...
                db.query(queryString4, (err, results4, fields) => {
                    ...
                    db.query(queryString5, (err, results5, fields) => {
                        ...
                        ORDER BY tbl_notification.int_notifID DESC`
                            ...
                            res.render('barangay/releasing/views/viewproj', {tbl_projectproposal:results, tbl_projectrequirement:results2, tbl_projectbeneficiary:results3, tbl_releaselocation:results4,tbl_projectcategory:results5,notifications:notifications,
                                numbernotif:countrow});
                            });            
    });});});});
});
