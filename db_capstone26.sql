...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2018 at 03:55 PM
...
(5, 1, 2017, '1200000.00', '-474691143.00'),
(6, 1, 2018, '5000000.00', '3978850.00'),
(8, 1, 2019, '2710000.00', '2010000.00');
...
(229, 4, 40, 'Household', 'Rejected', NULL, '2018-10-19 13:59:56');
...
(762, 225, 14, 'C', ''),
(763, 229, 14, 'cab1roww2', 'Passed'),
(764, 229, 1, 'cab1roww1', 'Passed');
...
(52, 40, 'Benefit Expense', 200, '900.00', '0.00', NULL, NULL);
...
(1, 229, 'lyka', 'pu', 'dela cruz', 'Single', 'college', 'none'),
(2, 229, 'angelika', 'pu', 'dela cruz', 'Single', 'college', 'hr');
...
(1, 229, 'Household expense', 'sister', 'Monthly', '120000.00');
...
INSERT INTO `tbl_householdapplication` (`int_applicationID`, `varchar_familyName`, `text_homeAddress`, `varchar_representativeName`, `varchar_representativeEmailAddress`, `varchar_representativeContact`, `decimal_totalAnnualIncome`, `enum_houseStatus`) VALUES
(229, 'dela cruz', '535 hulo', 'abigale', 'abigaledr13@gmail.com', '(+63) 961-626-5665', '120000.00', 'Owned');
...
(40, 1, 'For household', 'to help the household', 'to help the household', 'to help the household', 200, '2018-10-20', '2018-10-31', '2018-11-09', '2018-11-09', '2018-11-14', '2018-10-19', NULL, NULL, '2018-10-19', '0.00', '200000.00', NULL, 'Ongoing');
...
(61, 40, 'ugugggu', 'Start Application');
...
--
ALTER TABLE `tbl_application`
  MODIFY `int_applicationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=230;

--
-- AUTO_INCREMENT for table `tbl_applicationrequirement`
--
ALTER TABLE `tbl_applicationrequirement`
  MODIFY `int_appreqID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=765;
...
--
ALTER TABLE `tbl_familybackground`
  MODIFY `int_familybgID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbl_financialcontribution`
--
ALTER TABLE `tbl_financialcontribution`
  MODIFY `int_financialconID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tbl_projectapplicationtype`
  MODIFY `int_proapptypeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `tbl_projectbeneficiary`
--
ALTER TABLE `tbl_projectbeneficiary`
  MODIFY `int_projbeneID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
...
--
ALTER TABLE `tbl_projectreason`
  MODIFY `int_projectReasonID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT for table `tbl_projectrequirement`
--
ALTER TABLE `tbl_projectrequirement`
  MODIFY `int_projreqID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
