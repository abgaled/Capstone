...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 01, 2018 at 01:09 AM
...
(1, 'Barangay Solver of the Year (2018)', 'Masipag magpasa ng statement', 'Active');
...
(1, 'Financial', 'Projects that gives financial support.', 'Active');
...
(1, '2018-05-01', '2018-05-31', '2018-05-16', '2018-06-05', '1000000.00', '', 'Active'),
(2, '2018-05-31', '2018-06-15', '2018-06-02', '2018-06-12', '1000000.00', '', 'Active'),
...
(2, 'Monetary', 'Giving money for good purposes.', 'Active');
...
--
ALTER TABLE `tbl_requirement`
  MODIFY `int_requirementID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
