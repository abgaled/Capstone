...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 31, 2018 at 07:40 PM
...
(2, '13', 'Buli', 'Batangas', 'Mandaluyong City', 'Permanent'),
(3, '13', 'Buli', 'Batangas', 'Mandaluyong City', 'Permanent');
...
(2, 3, 3, 'Abigale', 'Punzalan', 'Del Rosario', '1999-06-13', 'Female', 1999, 'Single', '09156662933', 'abigale@gmail.com');
...
CREATE TABLE `tbl_professionalbg` (
  ...
  `varchar_position` varchar(100) NOT NULL,
  `varchar_companyName` varchar(100) NOT NULL,
  `varchar_companyAddressID` int(11) NOT NULL,
  `int_applicationID` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, '2018-07-31', '2018-08-31', '2018-08-15', '1000000', 'Open');
...
(1, 1, 1, 'Medicine Giving', 'Residents who really need these medicines will acquire it.', 'To help the residents who have a major or minor health issues.', 'Distribution of medicines for the residents. Limited supplies only.', 100, 100, '1000000', '2018-05-15', 'New'),
...
(7, 1, 1, 'Distribution of Supplies for Fire Victims', 'Residents will received their supplies.', 'Give the residents who were affected by the fire. Given that they pass the required requirementsl.', 'Giving of supplies to residents. First come first served service (first to complete the requirements will automatically gain a slot).', 100, 100, '350000', '2018-06-06', 'Approved');
...
INSERT INTO `tbl_releaselocation` (`int_locationID`, `varchar_locationName`, `int_locationAddressID`, `enum_locationStatus`) VALUES
(1, 'City Hall', 1, 'Active');
...
--
ALTER TABLE `tbl_address`
  MODIFY `int_addressID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `tbl_application`
  MODIFY `int_applicationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `tbl_releaselocation`
  MODIFY `int_locationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
